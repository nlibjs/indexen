...
import { indexen } from './indexen.mjs';
...
program.option(
  '-e, --exclude <patterns...>',
  'Patterns of files to be excluded. It will be passed to fast-glob.',
);
program.option(
  '--noext',
  'It true, the output will be [export * from "./a"] not [export * from "./a.js"].',
);
program.argument(
  '<patterns...>',
  'Patterns of files to be included. It will be passed to fast-glob.',
);
